<?php 
require('Model/mostrarLlegada.php')
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="contenido">
            ...
            <div class="filtros">
                ...
                <div class="filtros_nav">
                    <div class="fa-solid fa-bars-staggered" id="primero"><p>Orden de Llegada</a></div>
                    <div class="fa-solid fa-users-viewfinder"><p>Instructor</p></div>
